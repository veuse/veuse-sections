jQuery(document).ready(function($){
	...
	$('.veuse-section-tabnav li a:first').addClass('active');
	$('.veuse-section-tab:first').show();
	
	$('.veuse-section-tabnav li a').click(function() {	 
		 
		 tab = $(this).attr('href');
		 $('.veuse-section-tabnav li a').removeClass('active');
		 $(this).addClass('active');
		 $('.veuse-section-tab').hide();
		 $(tab).show();
		 return false;
